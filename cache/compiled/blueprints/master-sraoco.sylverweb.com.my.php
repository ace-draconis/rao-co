...
return [
    ...
    'timestamp' => 1601019981,
    'checksum' => '1714de4b18a3fa72ee9d8ead332842e4',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/googlemaps' => [
                'file' => 'user/plugins/googlemaps/blueprints.yaml',
                'modified' => 1549714637
            ],
            'plugins/email' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.googlemaps.enabled' => [
                ...
                'name' => 'plugins.googlemaps.enabled',
                'validation' => 'strict'
            ],
            'plugins.googlemaps.built_in_css' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.googlemaps.built_in_css',
                'validation' => 'strict'
            ],
            'plugins.email' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'googlemaps' => [
                    'enabled' => 'plugins.googlemaps.enabled',
                    'built_in_css' => 'plugins.googlemaps.built_in_css'
                ],
                'email' => [
