...
class __TwigTemplate_67db1652f6ff3e0c7d59d229fb6301bcc9d5ab06462bf07e62f8b864cb8817d9 extends \Twig\Template
{
...
&lt;p&gt;</p>
    ";
        // line 5
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute(($context["page"] ?? null), "media", []), "20151026110308_43018.jpg", [], "array"), "html", [0 => "My title", 1 => "Some ALT text", 2 => "img-responsive"], "method"), "html", null, true);
        echo "
<pre><code>    &lt;/p&gt;</code></pre>
<p>&lt;/div&gt;<br />
